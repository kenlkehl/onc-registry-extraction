...
Usage::
    ...
    # XML -> JSON
    naaccr-convert output/naaccr_output.xml output/naaccr_output.json

    # XML -> CSV
    naaccr-convert output/naaccr_output.xml output/naaccr_output.csv

    # With human-readable item names instead of XML IDs
    naaccr-convert output/naaccr_output.xml output/data.csv --readable-names

    # Include only non-empty fields
    naaccr-convert output/naaccr_output.xml output/data.json --skip-empty
"""
...
def main() -> None:
    """CLI entry point for naaccr-convert."""
